...
public class Constants {
    ...
    public static final double LINE_DETECTION_MINIMUM  = 0.19;

    public static final double PUSHER_SERVO_MAX = 0.2;
    public static final double PUSHER_SERVO_MIN = 0.8;
            ;

    public static final double LIGHT_SENSOR_RED_MIN = 500;
    public static final double LIGHT_SENSOR_BLUE_MIN = 500;
